...
const Hero = () => {
  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 flex flex-col w-full justify-center items-center bg-[url('/gradientBackground.png')] bg-cover bg-center bg-no-repeat min-h-screen">
